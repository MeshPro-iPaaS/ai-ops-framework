...
| 2 | Ask the five questions | Ross | The account | Gaps named |
| 3 | Write the note from the template | Ross | The template | A draft note |
| 4 | Set `readiness` from evidence | Ross | Honesty | not-yet · partly · ready |
