...
| `05 - Operations/picture/*.html` | The four pages | Edit the existing page. Keep the counts honest — count the notes yourself before you change a number |
...
Role notes first, then the register, then the pages. A page built before the register is a page
