...
| 2 | Find the **one** note that owns it | Chief of Staff | The contract's routing table | A single target |
| 3 | Edit that note, and only that note | Chief of Staff | — | A changed source |
| 4 | Run the installer | Agent or you | Python | Everything downstream agrees |
| 5 | Check, then log one line | Chief of Staff | — | A green check and a record |
