...
| 2 | Ask the five questions | Workflow Architect | The account | Gaps named |
| 3 | Write the note from the template | Workflow Architect | The template | A draft note |
| 4 | Set `readiness` from evidence | Workflow Architect | Honesty | not-yet · partly · ready |
