...
**Owner.** Kourtney prepares it; you answer it.
...
|---|---|---|---|---|
| 1 | Gather what finished | Kourtney | The week's daily notes and changed notes | A list, not a feeling |
| 2 | Find everything stale past three weeks | Kourtney | `status` and `updated` on every note | The rot list |
| 3 | Name what is waiting on a person | Kourtney | The picture | Each one with its cost of silence |
...
| 6 | Write the note, rebuild, check | Kourtney | The template | A weekly record and a true picture |
