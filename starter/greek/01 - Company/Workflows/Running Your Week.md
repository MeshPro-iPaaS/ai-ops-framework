...
**Owner.** Athena prepares it; you answer it.
...
|---|---|---|---|---|
| 1 | Gather what finished | Athena | The week's daily notes and changed notes | A list, not a feeling |
| 2 | Find everything stale past three weeks | Athena | `status` and `updated` on every note | The rot list |
| 3 | Name what is waiting on a person | Athena | The picture | Each one with its cost of silence |
...
| 6 | Write the note, rebuild, check | Athena | The template | A weekly record and a true picture |
