...
**Owner.** Saga prepares it; you answer it.
...
|---|---|---|---|---|
| 1 | Gather what finished | Saga | The week's daily notes and changed notes | A list, not a feeling |
| 2 | Find everything stale past three weeks | Saga | `status` and `updated` on every note | The rot list |
| 3 | Name what is waiting on a person | Saga | The picture | Each one with its cost of silence |
...
| 6 | Write the note, rebuild, check | Saga | The template | A weekly record and a true picture |
