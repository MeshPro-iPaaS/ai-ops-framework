...
| 2 | Write it as a skill | Ross | `_Templates/Skill.md` | `.claude/skills/{name}/SKILL.md` |
| 3 | Say when it applies | Ross | Step 1 | A description concrete enough to trigger on |
| 4 | Set owner: to its executive | Ross | A name or a job title | It appears under that executive in the catalog |
| 5 | Use it on something real | You | A live case | Proof, or a list of what it got wrong |
| 6 | Fix what the case showed | Ross | Step 5 | A skill that survived contact |
