...
**Owner.** Kourtney prepares; a person decides.
...
flowchart TB
    ...
    B["🤖 Kourtney drafts the record:<br/>the question · what was considered · what it costs"]:::ai
...
|---|---|---|---|---|
| 1 | Name the question in one sentence | Kourtney | The conversation | A record at `proposed` |
| 2 | List the options honestly, including doing nothing | Kourtney | Evidence, tagged [F]/[A]/[R] | A comparison |
| 3 | Decide | You | The record | `decided`, `decided_by`, a date |
| 4 | Write what follows | Kourtney | The decision | Owned consequences |
