...
| 2 | Find the **one** note that owns it | Kourtney | The contract's routing table | A single target |
| 3 | Edit that note, and only that note | Kourtney | — | A changed source |
| 4 | Run the installer | Agent or you | Python | Everything downstream agrees |
| 5 | Check, then log one line | Kourtney | — | A green check and a record |
