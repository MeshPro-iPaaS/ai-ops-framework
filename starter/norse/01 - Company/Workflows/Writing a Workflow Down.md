...
| 2 | Ask the five questions | Bragi | The account | Gaps named |
| 3 | Write the note from the template | Bragi | The template | A draft note |
| 4 | Set `readiness` from evidence | Bragi | Honesty | not-yet · partly · ready |
