...
| 2 | Find the **one** note that owns it | Monica | The contract's routing table | A single target |
| 3 | Edit that note, and only that note | Monica | — | A changed source |
| 4 | Run the installer | Agent or you | Python | Everything downstream agrees |
| 5 | Check, then log one line | Monica | — | A green check and a record |
