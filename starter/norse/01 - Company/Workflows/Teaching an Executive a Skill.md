...
| 2 | Write it as a skill | Bragi | `_Templates/Skill.md` | `.claude/skills/{name}/SKILL.md` |
| 3 | Say when it applies | Bragi | Step 1 | A description concrete enough to trigger on |
| 4 | Set owner: to its executive | Bragi | A name or a job title | It appears under that executive in the catalog |
| 5 | Use it on something real | You | A live case | Proof, or a list of what it got wrong |
| 6 | Fix what the case showed | Bragi | Step 5 | A skill that survived contact |
