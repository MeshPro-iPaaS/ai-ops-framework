...
| 2 | Ask the five questions | Hermes | The account | Gaps named |
| 3 | Write the note from the template | Hermes | The template | A draft note |
| 4 | Set `readiness` from evidence | Hermes | Honesty | not-yet · partly · ready |
