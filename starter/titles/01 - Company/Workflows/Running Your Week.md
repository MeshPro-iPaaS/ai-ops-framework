...
**Owner.** Chief of Staff prepares it; you answer it.
...
|---|---|---|---|---|
| 1 | Gather what finished | Chief of Staff | The week's daily notes and changed notes | A list, not a feeling |
| 2 | Find everything stale past three weeks | Chief of Staff | `status` and `updated` on every note | The rot list |
| 3 | Name what is waiting on a person | Chief of Staff | The picture | Each one with its cost of silence |
...
| 6 | Write the note, rebuild, check | Chief of Staff | The template | A weekly record and a true picture |
